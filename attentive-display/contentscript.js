window.xLabs = {
  ...
  callbackIdPath: null,
  requestAccessIdx: 0,
  developerToken: "b371ca47-9f99-4a2d-93c3-42eca4961afc",

  XLABS_EXTENSION_ID: "emeeadaoegehllidjmmokeaahobondco",
  ...
  //   return chrome.runtime.getManifest !== undefined // FIXME:
  // },
...
function main() {
  $(document.body).append('<div id="testingDiv"></div>');
}
